...
6) и результат достаточно впечатляющий : набрали 92% из 100 рандомных примеров. Но стоит учитывать, что здесь достаточно простые примеры по сравнению с swebench.
7) другие метрики досчитаю позже
